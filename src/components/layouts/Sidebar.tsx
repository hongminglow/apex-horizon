...
export function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="shrink-0 border-r border-border bg-[var(--sidebar-bg)] h-screen sticky top-0 overflow-hidden relative z-40"
    >
      <AnimatePresence initial={false}>
        {sidebarCollapsed ? (
          <motion.div
            ...
            className="flex flex-col items-center py-4 gap-4 w-14 h-full absolute top-0 left-0"
          >
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[var(--gradient-start)] to-[var(--gradient-end)] flex items-center justify-center shrink-0">
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.2 }}
            className="flex flex-col w-64 h-full absolute top-0 left-0 bg-[var(--sidebar-bg)]"
          >
            {/* Header */}
            ...
            <div className="flex items-center gap-3 p-4 border-b border-border shrink-0">
              <div className="w-9 h-9 rounded-full bg-accent-muted flex items-center justify-center text-accent text-xs font-bold shrink-0">
                {user?.avatar ?? 'AH'}
              </div>
